 ...
 * Configuration:   Default configuration + FAST_EXIT_NO_USB_MS=700
 *       USB D- :   PB3
 *       USB D+ :   PB4
 *       Entry  :   Always
 *       LED    :   None
 *       OSCCAL :   Stays at 16.5 MHz
 * Note: Uses 16.5 MHz V-USB implementation with PLL
 * Last Change:     Sep 16,2020
 *
...
#define FAST_EXIT_NO_USB_MS     700 // Values below 120 are ignored. Effective timeout is 300 + FAST_EXIT_NO_USB_MS.
