...
@if exist %FILENAME% (
@rem   ..\windows_exe\avrdude.exe -c micronucleus -p t85 -V -U flash:w:%FILENAME%:i
...
@rem   ..\windows_exe\avrdude.exe -c micronucleus -p t85 -V -U flash:w:..\firmware\upgrades\%FILENAME%:i
:end
pause